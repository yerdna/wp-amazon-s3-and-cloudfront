...
class Linode_S3_Provider extends AWS_Provider {
	 ...
	 * @var string
	 */
	protected static $service_name = 'linode Object Storage';

	/**
	 * @var string
	 */
	protected static $service_short_name = 'LinodeStorage';
	 ...
	 * @var string
	 */
	protected static $service_key_name = 'linode';
	 ...
	 * @var string
	 */
	protected static $provider_service_quick_start_slug = 'linode-storage-quick-start-guide';
	 ...
	 * @var string
	 */
	protected static $default_region = 'eu-central-1';
	 ...
	 * @var string
	 */
	protected $console_url = 'https://cloud.linode.com/object-storage/buckets/eu-central/';
